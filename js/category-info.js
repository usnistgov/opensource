app.controller('gitHubDataController', function($scope, $http, $window, Category) {
    ...
    var getReposLogos = $http.get('/opensource/assets/images/logos/repo_logos.json', {
        cache: true
    });
